...
/// It only forwards button clicks to LegoTwoPanelMenuController.
/// </summary>
public class LegoWristButtons : MonoBehaviour
{
    [Header("Menu Controller")]
    [SerializeField] private LegoTwoPanelMenuController menuController;
    ...
    {
        if (menuController != null)
            menuController.ToggleMusicMenu();
    }
